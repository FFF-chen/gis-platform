...
HUIJI_PO_DATA = [
    # ---- 景区景点 ----
    {"id": 1,  "name": "燕岩风景区",        "type": "景区", "lat": 23.908, "lng": 112.228, "desc": "中国最佳溶洞奇观，万燕归巢壮景，被誉为'岭南第一洞'", "rating": "4A"},
    {"id": 2,  "name": "世外桃源景区",       "type": "景区", "lat": 23.916, "lng": 112.213, "desc": "陶渊明笔下桃花源原型地，溪流潺潺，桃林环绕", "rating": "4A"},
    {"id": 3,  "name": "燕峰峡漂流",         "type": "景区", "lat": 23.952, "lng": 112.160, "desc": "广东最长漂流河道，全长5.8公里，刺激与美景并存"},
    ...
    {"id": 8,  "name": "凤岗河湿地公园",      "type": "景区", "lat": 23.960, "lng": 112.195, "desc": "生态湿地公园，鸟类栖息天堂，徒步骑行佳地"},
    {"id": 9,  "name": "下帅壮族瑶族乡",      "type": "景区", "lat": 23.885, "lng": 112.155, "desc": "广东唯一的壮族瑶族乡，浓郁民族风情体验"},

    # ---- 农家乐 ----
    {"id": 10, "name": "燕岩农家乐",         "type": "农家乐", "lat": 23.910, "lng": 112.224, "desc": "燕岩景区旁，地道怀集农家菜，招牌黄焖鸡"},
    {"id": 11, "name": "桃花源农家院",       "type": "农家乐", "lat": 23.918, "lng": 112.210, "desc": "世外桃源入口处，柴火灶烧菜，新鲜食材自家种养"},
    {"id": 12, "name": "绿水青山农家乐",      "type": "农家乐", "lat": 23.936, "lng": 112.172, "desc": "依山傍水，可垂钓采摘，适合家庭聚会"},
    {"id": 13, "name": "田园小筑",           "type": "农家乐", "lat": 23.942, "lng": 112.200, "desc": "近县城，环境清幽，特色竹筒饭、窑鸡"},
    {"id": 14, "name": "山泉人家",           "type": "农家乐", "lat": 23.955, "lng": 112.188, "desc": "山泉水养殖鱼类，现捞现做，鲜美无比"},

    # ---- 农庄 ----
    {"id": 15, "name": "怀集生态农庄",       "type": "农庄", "lat": 23.940, "lng": 112.220, "desc": "大型生态种植基地，草莓/葡萄采摘，亲子体验"},
    {"id": 16, "name": "岭南佳果园",         "type": "农庄", "lat": 23.915, "lng": 112.195, "desc": "四季水果采摘园，砂糖橘、百香果、火龙果"},
    {"id": 17, "name": "绿丰源农业庄园",      "type": "农庄", "lat": 23.930, "lng": 112.235, "desc": "珠三角蔬菜供应基地，可体验农耕文化"},
    {"id": 18, "name": "山水田园农庄",        "type": "农庄", "lat": 23.948, "lng": 112.165, "desc": "集餐饮住宿采摘一体，怀集特色全牛宴"},

    # ---- 餐饮美食 ----
    {"id": 19, "name": "怀集味道（总店）",    "type": "餐饮", "lat": 23.926, "lng": 112.188, "desc": "怀集本地菜标杆，招牌菜：怀集切粉、酿豆腐、白切怀集鸡"},
    {"id": 20, "name": "桥头酒楼",           "type": "餐饮", "lat": 23.924, "lng": 112.185, "desc": "三十年老店，怀集地道早茶、粤菜经典"},
    {"id": 21, "name": "燕城美食坊",         "type": "餐饮", "lat": 23.929, "lng": 112.183, "desc": "汇聚怀集各乡镇特色小吃，价格亲民"},
    {"id": 22, "name": "江畔渔港",           "type": "餐饮", "lat": 23.932, "lng": 112.180, "desc": "绥江边上，河鲜现点现做，环境雅致"},
    {"id": 23, "name": "竹乡人家",           "type": "餐饮", "lat": 23.920, "lng": 112.192, "desc": "怀集特产竹笋宴，全竹宴闻名远近"},

    # ---- 住宿酒店 ----
    {"id": 24, "name": "怀集华苑大酒店",      "type": "住宿", "lat": 23.925, "lng": 112.187, "desc": "县城中心四星级酒店，交通便利，设施齐全"},
    {"id": 25, "name": "燕峰峡温泉酒店",      "type": "住宿", "lat": 23.950, "lng": 112.162, "desc": "温泉入户，依山而建，度假首选"},
    {"id": 26, "name": "桃花源民宿",         "type": "住宿", "lat": 23.917, "lng": 112.212, "desc": "景区特色民宿，推窗见景，远离喧嚣"},
]
